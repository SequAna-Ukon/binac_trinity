...
if __name__=="__main__": 
    ...
    r1out=open('unfixrm_{}'.format(basename(opts.leftreads).replace(".gz","")) ,'w')
    r2out=open('unfixrm_{}'.format(basename(opts.rightreads).replace(".gz","")) ,'w')
    ...
    unfix_log=open('rmunfixable_{}.log'.format(opts.id),'w')
